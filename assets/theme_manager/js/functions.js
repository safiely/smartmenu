...
$(document).ready(function(){
   //Adapt the main header width if the name of products is too long
   function adapt_main_header(){
      $('.main_header_title').css('width',$(window).width()-$('li.logo').width()-100);
      $('.main_header_title').css('overflow','hidden');
      $('.main_header_title').css('white-space','nowrap');
      $('.main_header_title').css('text-overflow','ellipsis');
   }
   adapt_main_header();
   $(window).resize(adapt_main_header);
});
...
$(document).ready(function(){
  ...
  /*
   ...
   $('#test_ju').click(function(){
      console.log('NOTIF');
      notify('top', 'right', '', 'success', 'animated fadeIn', 'animated fadeOut', 'Welcome back ', 'Mallinda Hollaway!');
   });
   */
